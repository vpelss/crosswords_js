...
See "Emogics_Crossword_Algorithm.rtf" for a better formatted version of this text.
...
In complex associative arrays with multiple layers the keys were set in the following order.
dir , y , x
dir , word_number
...
this_square_belongs_to_word_number[dir][y][y] returns the word number this square belongs to
